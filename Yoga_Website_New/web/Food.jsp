							...
							<div class="row">
								...
								<div class="widget-title">
									<h4 class="title">Food</h4>
                                                                        <p style="text-align: justify">Samparana Yogashala provides a balanced and sattvic diet which helps not only to promote the physical well-being but also the health and clarity of the mind.</p>
								</div>
                                <ul>
									<li class="cat-item"><a href="#">We use fresh organic fruits, vegetables and grains that are picked directly from our farm.</a></li>
                                    <li class="cat-item"><a href="#" style="text-align: justify">Instead of sugar we use natural sweeteners like jaggery and avoid the use of processed foods.</a></li>                       
                                    <li class="cat-item"><a href="#" style="text-align: justify">Our food is completely vegan as we strongly believe in the principles of non-violence and compassion for all living beings.</a></li>
									<li class="cat-item"><a href="#" style="text-align: justify">We prepare light and easily digestible meals that help to cleanse the body from within and allow to absorb maximum nutrients from food. </a></li>
									<li class="cat-item"><a href="#" style="text-align: justify">We refrain from any kind of caffeine, alcohol or highly spiced food as it can interfere with the practice of meditation. </a></li> 
                                                                        <li class="cat-item"><a href="#" style="text-align: justify">We also provide customised meal plans on special request in case of specific medical conditions. </a></li> 
                                                                        <li class="cat-item"><a href="#" style="text-align: justify">Filtered and clean water is available all day to keep you hydrated all the time. </a></li> 
                                </ul>
                            </div>
								</div>
