<%-- 
    Document   : Tejomayaanda_Swamiji
    Created on : 29 Jul, 2023, 1:53:08 PM
    Author     : nandy
--%>
...
<head>
	...
	<!-- Title -->
	<title>Yoga Trainer - Samarpana YogaShala</title>
				...
				<div class="row">
					<div class="col-xl-4 col-lg-4 m-b30">
						<aside class="sticky-top">
							<div class="yoga-media rounded-md m-b30">
                                                            <img src="pics/swamiji.png" class="rounded-md" alt="">
							</div>
					...
					<div class="col-xl-8 col-lg-8">
						<div class="section-head m-0">
							<h5 class="sub-title">YOGA TRAINER</h5>
                                                        <div class="widget-title">
							<h2 class="title">Sri Tejomayananda swamiji</h2>
                                                        </div>
						</div>
                                            <p style="text-align: justify">Sri Tejomayananda swamiji was a Mechanical Engineer.  After some years of service, he renounced all family relationships and took sannyasa from the great saint Sri Siddheshwar swamiji. He has wandered all over India as a mendicant and service to many types of saints and leart lessons from them. He also learnt Hatha yoga for 3 years. He has been delivering classes  on Bhagavat Gita, Scriptures of Vedanta and texts of Yoga.</p>	
			...
			<div class="container">
				<div class="row">
					<div class="col-xl-4 col-lg-4 m-b30">
						<aside class="sticky-top">
							<div class="yoga-media rounded-md m-b30">
                                                            <img src="img/abt/Dr Sangeeth Sukumarapillai.jpg"  class="rounded-md" alt="">
							</div>
					...
					<div class="col-xl-8 col-lg-8">
						<div class="section-head m-0">
							<h5 class="sub-title">YOGA TRAINER</h5>
                                                        <div class="widget-title">
							<h2 class="title">Dr Sangeeth Sukumarapillai</h2>
                                                        </div>
						</div>
						<p style="text-align: justify">Dr Sangeeth Sukumarapillai born in a traditional ayurvedic family in south Kerala.  After his graduation on Ayurveda he started his profession as junior doctor in KP Pathrose Kandamkulathy Ayurveda and he gained experience under various Famous Ayurvedic Hospitals and retreats. He continued his studies along with the practice of Ayurveda and got experienced in Ayurveda Panchakarma, Yoga and Marma Therapy. He is one of the few doctors in Kerala who is experienced in traditional Kerala Ayurveda and massage therapy ( Kalari treatments) and personally doing treatments to patients. He was also formar head of department for Panchakarma in AVN Arogya Hospital Tamil Nadu. Beyond a well practitioner in Ayurveda he is also good Trainer in Ayurvedic treatments and have more than 3000 students both native and international</p>	
			...
			<div class="container">
				<div class="row">
					<div class="col-xl-4 col-lg-4 m-b30">
						<aside class="sticky-top">
							<div class="yoga-media rounded-md m-b30">
                                                            <img src="img/abt/Abishek_Rawat.jpg" class="rounded-md" alt="">
							</div>
					...
					<div class="col-xl-8 col-lg-8">
						<div class="section-head m-0">
							<h5 class="sub-title">YOGA TRAINER</h5>
                                                        <div class="widget-title">
							<h2 class="title">Abhishek Rawat</h2>
                                                        </div>
						</div>
						<p style="text-align: justify">Abhishek Rawat was born and bought up in the World's Yoga Capital, Rishikesh. Abhishek was inclined towards Yoga from Childhood. Abhishek received a Masters Degree in Yoga Science from Sanskrit Gurukul Vishvidyalaya, in Haridwar, India. He has completed 500 hours of teacher training, studied with various great Indian teachers and attended an intensive Ashtanga and iyengar yoga courses in Rishikesh.</p>	
                                                <p style="text-align: justify">He is an experienced Ashtanga yoga teacher and believes in the spreading of this art of wellness to eradicate the disease in a natural way. He is a true believer in the power of yogic practice and meditation but always likes to remind his students that The power is not in Yoga itself, the true power is already within you. Yoga is just the key to unlocking this treasure.</p>
                                                <p style="text-align: justify">His vision is to spread the learning that he have earn from his teachers and to help them to live meaningful life.</p>
			...
			<div class="container">
				<div class="row">
					<div class="col-xl-4 col-lg-4 m-b30">
						<aside class="sticky-top">
							<div class="yoga-media rounded-md m-b30">
                                                            <img src="img/abt/Vimal.jpeg" class="rounded-md" alt="">
							</div>
					...
					<div class="col-xl-8 col-lg-8">
						<div class="section-head m-0">
							<h5 class="sub-title">YOGA TRAINER</h5>
                                                        ...
                                                        <div class="widget-title">
									<h2 class="title">Vimal Sharma</h2>
								</div>
						</div>
						<p style="text-align: justify">Vimal Sharma is a Certified Yoga Teacher offering more than fourteen years of extensive experience. </p>	
                                                <p style="text-align: justify">His Yoga journey began in 2006 when he met his master H.H. Swami Veda Bharati (A close disciple of H.H. Swami Rama of Himalaya), who initiated him in the path of Yoga & Meditation as thought by the Himalayan tradition.</p>
                                                <p style="text-align: justify">Vimal holds a Bachelor’s degree in Sanskrit, a Master’s degree in Philosophy, a Master’s degree in Yogic science, a Master's degree in vedic astrology (pursuing), the certification of four years of residency in Ashram programme (with 2006 class of “Swami Rama Institute of Meditation and Interfaith studies” at “Swami Rama Sadhaka Grama”- Ashram in Rishikesh). ERYT Yoga Alliance US. He is also a co-author of a book on Yoga-Sutra of Patanjali.</p>
                                                <p style="text-align: justify">Vimal has been continuosly shairing and teaching yoga, meditation and it's background philosophy to the aspirants taking part in the YTTC in Rishikesh from all across the globe for last several years.</p>
                                                <p style="text-align: justify">Vimal believes there is always a space for one to grow; provided, one remains a devout student throughout his/her life.</p>
			...
			<div class="container">
				<div class="row">
					<div class="col-xl-4 col-lg-4 m-b30">
						<aside class="sticky-top">
							<div class="yoga-media rounded-md m-b30">
                                                            <img src="pics/anilkumar.JPG" class="rounded-md" alt="">
							</div>
					...
					<div class="col-xl-8 col-lg-8">
						<div class="section-head m-0">
							<h5 class="sub-title">YOGA TRAINER</h5>
                                                        ...
                                                        <div class="widget-title">
									<h2 class="title">Anil Kumar</h2>
								</div>
						</div>
						<p style="text-align: justify">Anil Kumar started his journey at the prestigious Shanti Kunj Ashram, Haridwar – the divine land where the sacred Ganges flows from the Himalayas. He honed his passion for the sacred art of yoga under the revered guidance of some of the greatest gurus. He was guided and trained by Dr. Sunil Yadav. After that Anil Ji devoted his life to unearthing the gems of Yoga and Ayurveda. He is currently pursuing his P.hD in Yoga. He has earned various degrees including a Master’s degree in yogic sciences, a diploma degree in yoga and naturopathy and a certification in ayurveda and health conservation from reputed institutions. </p>	
                                                <p style="text-align: justify">He teaches hatha yoga, ashtanga vinyasa, alignment and adjustment, yin yoga, etc in a manner that is simple yet effective. Compassion, calmness and patience are his key attributes that perfectly compliment his skilled yogic teachings. He has almost nine years of intense teaching experience in world renowned schools, sharing his expertise while training dedicated global teachers to further the great cause of yoga. He maintains a cheerful attitude with a charming smile, one that endears to all his students.</p>
