		...
		<!-- Health Section -->
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<div class="clearfix">
							<h4>HOW TO REACH OUR SCHOOL</h4>
							<div class="dz-separator style-4"></div>
						</div>
						<p style="text-align: justify">BY AIR The nearest airport is Trivandrum International Airport, which is at a distance of 50 kms from Varkala. A student can get down at the airport and take a cab to the location of the school or ask school to arrange for a pickup while booking the course.</p>
                                                <p style="text-align: justify">BY BUS Varkala is well connected by national state highways from major cities and many governments as well as private buses that run to and fro from the city. </p>
                                                        <p style="text-align: justify">By TAXI PICK UP School provides taxi pick up at a cost of 25 USD only</p>
                                        </div>
				</div>
			</div>
		</section>
