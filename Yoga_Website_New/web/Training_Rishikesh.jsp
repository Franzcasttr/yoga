<%-- 
    Document   : Training_Rishikesh
    Created on : 29 Jul, 2023, 4:00:31 PM
    Author     : nandy
--%>
...
<div class="page-wraper">
	...
	<div class="page-content bg-white">
		...
		<div class="dz-bnr-inr style-1 text-center">
			<div class="container">
				<div class="dz-bnr-inr-entry">
					<h1>200 Hour Yoga Teacher Training In Rishikesh</h1>
					<!-- Breadcrumb Row -->
					<nav aria-label="breadcrumb" class="breadcrumb-row">
						<ul class="breadcrumb">
							<li class="breadcrumb-item"><a href="Home">Home</a></li>
							<li class="breadcrumb-item active" aria-current="page">200 Hour Yoga Teacher Training In Rishikesh</li>
						</ul>
					</nav>
					<!-- Breadcrumb Row End -->
				</div>
		...
		<div class="content-inner">
				...
				<div class="row">
					<div class="col-xl-4 col-lg-4 m-b30">
						<aside class="side-bar left sticky-top">
                            <div class="widget service_menu_nav">
								<ul>
									<li class="active"><a href="Training_Rishikesh">200 Hour Yoga Teacher Training In Rishikesh</a> </li>
									<li><a href="Training_Kerala">200 Hour Yoga Teacher Training In Kerala</a></li>
									<li><a href="Training_Nepal">200 Hour Yoga Teacher Training In Nepal</a> </li>
					...
					<div class="col-xl-8 col-lg-8">
						<div class="swiper service-slider m-b30">
							...
							<div class="swiper-pagination style-1"></div>
						</div>
						<div class="dz-content">
							<div class="m-b40">
								<h3 class="title">200 Hour Yoga Teacher Training In Rishikesh</h3>
                                                                <img src="pics/ryt_yoga.jpg" width="150"> <img src="pics/rys_yoga.jpg" width="140"><br>
                                                                <div class="dz-separator style-3">
								<img src="assets/images/lotus.svg" alt="">
							</div>
								<p style="text-align: justify">The 200-hour yoga teacher training course with us is all about deepening your practice and gaining confidence so that you can share it with the rest of the world. This course is designed for all those people who are ready to commit themselves to the path of Yoga and who are seeking inner transformation in their lives. Yoga Alliance Approved Yoga teacher training program by Pankaj Yogpeeth is a wonderful opportunity to achieve their desired goal happily and peacefully. At the same time, this course will help you to establish your career in Yoga as a wonderful teacher.</p>
							</div>
							<div class="widget widget_categories ">
								<div class="widget-title">
									<h4 class="title">Key Highlights of yoga training course in Rishikesh.</h4>
                                                                       
								</div>
                                <ul>
                                    <li class="cat-item" style="text-align: justify"><a href="#" style="text-align: justify"><b style="color: brown">Personal Growth</b> – First and foremost highlight of our yoga training course is your personal growth. We all know that we cant change what has happened in our past, but through yoga we can understand how we should react on the situations and how to handle complex times with ease which will in return make our future more bright. This reduces the mistakes which are often repeated and drives a self confidence in ourselvesto overcome any negative things or any difficult situation.</a></li>
                                    <li class="cat-item" style="text-align: justify"><a href="#" style="text-align: justify"><b style="color: brown">Heading to Next level</b> – Through Yoga training course you will not only learn the benefits and importance of yoga, but you learn even more when you start practicing and teaching yoga. There is no end when it comes to learning yoga. It’s a lifetime learning. The more you practice the more you deep dive in the subject.</a></li>
                                    <li class="cat-item" style="text-align: justify"><a href="#" style="text-align: justify"><b style="color: brown">Interaction with new people </b> –  Along with the deeper understanding of yoga, another key highlight of this course is you make connections with various people who are like minded individuals and share same passion for yoga. This is because people from all over world come to us for teacher training in yoga. Hence, you get a chance to interact with wide range of people across the globe.</a></li>
                                    <li class="cat-item" style="text-align: justify"><a href="#" style="text-align: justify"><b style="color: brown">Development of skills </b> – We at samarpana yogashala not only teach yoga but also help you to create a well-rounded journey that starts with warming up the body and gradually moves towards more challenging poses. This will enable you to get the better understanding of yoga and you can teach the same to others in more effective way.</a></li>
                                    <li class="cat-item" style="text-align: justify"><a href="#" style="text-align: justify"><b style="color: brown">Knowledge of Human Anatomy </b> – We also provide sessions on human anatomy in our courses. This is because in order to teach safe and effective yoga it is important to understand the knowledge of human anatomy. This will help you to understand the poses in more effective ways.</a></li>
                                    <li class="cat-item" style="text-align: justify"><a href="#" style="text-align: justify"><b style="color: brown"> Physical Flexibility  </b> – One of the key highlights of our teacher training course is improved physical flexibility. This is because you learn new poses and how to do that in correct form which in turn makes your body more flexible. As a result of this you will be able to bend over backward like never before, but with practice. It also helps in strength building as well.</a></li>
                                    <li class="cat-item" style="text-align: justify"><a href="#" style="text-align: justify"><b style="color: brown">You can change your life and change the whole world  </b> –  Through our teacher training course you come out of this experience as a new person. A person who is filled with knowledge, wisdom and many light bulb moments. You become strong enough not only physically but mentally as well to fight across any given situations. Also you now become the part of rapidly growing Yoga community across globe. This all helps you to change the whole world by spreading love, peace and unity.</a></li>
                                    ...
                                    <section class="content-inner-1 section-wrapper6 overflow-hidden">
			<div class="container">
				<div class="section-head style-1 text-center">
					<h3 data-wow-delay="0.2s">Upcoming Yoga Courses</h3>
					<div class="dz-separator style-3">
								<img src="assets/images/lotus.svg" alt="">
							</div>
				</div>
				<div class="swiper-container blog-slider-full blog-slider-wrapper">
					<div class="swiper-wrapper">
						<div class="swiper-slide wow fadeInUp" data-wow-delay="0.2s">
							<div class="dz-card style-1 green overlay-shine">
								<div class="dz-media">
                                                                    <a href="#!"><img src="img/course/c1.jpg" alt=""></a>
								</div>
								<div class="dz-info">
									
									
									<h4 class="dz-title"><a href="#!">100 Hours Yoga Teacher Training in Rishikesh - October 2023</a></h4>
									<div class="dz-meta">
										<ul>
						...
						<div class="swiper-slide wow fadeInUp" data-wow-delay="0.4s">
							<div class="dz-card style-1 green overlay-shine">
								<div class="dz-media">
                                                                    <a href="#!"><img src="img/course/c2.jpg" alt=""></a>
								</div>
								<div class="dz-info">
									
									
									<h4 class="dz-title"><a href="#!">300 Hour Yoga Teacher Training in Rishikesh - October 2023</a></h4>
									<div class="dz-meta">
										<ul>
						...
						<div class="swiper-slide wow fadeInUp" data-wow-delay="0.6s">
							<div class="dz-card style-1 green overlay-shine">
								<div class="dz-media">
                                                                    <a href="#!"><img src="img/course/c3.jpg" alt=""></a>
								</div>
								<div class="dz-info">
									
									
									<h4 class="dz-title"><a href="#!">200 Hour Yoga Teacher Training in Rishikesh - October 2023</a></h4>
									<div class="dz-meta">
										<ul>
											<li class="post-date">
												<a href="javascript:void(0);">
													<i class="flaticon-"></i>
                                                                                                        <span style="color:#277381 "><b>PRICE- 1500$</b></span>
												</a>
											</li>
											<li class="post-time">
												<a href="javascript:void(0);"> 
			...
			<svg class="blog-wave" width="586" height="147" viewbox="0 0 586 147" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path d="M607.61 121.63C579.856 114.343 558.555 98.7402 538.416 81.4316C519.028 64.7697 499.824 47.22 474.585 37.0841C422.552 16.1885 361.423 26.7849 310.459 44.7003C253.514 64.7194 200.016 94.8424 138.433 103.63C108.235 107.939 75.9219 105.87 49.6215 91.3926C27.8298 79.3987 16.0195 60.4011 11.0981 39.0462C8.30255 26.9163 7.34412 14.591 6.58929 2.25203H-6.10352e-05C0.207581 5.74986 0.431213 9.24199 0.71344 12.7193C2.35211 32.9235 5.55499 53.9174 17.9271 71.594C31.9805 91.6714 56.8858 104.419 83.2461 109.053C115.413 114.707 148.773 109.318 179.485 100.557C209.076 92.1159 237.093 80.2066 265.131 68.6184C318.646 46.5012 377.958 24.0538 438.834 33.3818C453.074 35.5643 466.904 39.5786 479.521 45.6819C491.974 51.7062 502.937 59.6161 513.265 68.0401C533.474 84.5237 551.769 103.257 575.903 115.731C600.85 128.627 630.919 134.304 659.871 131.653C659.913 131.649 659.957 131.642 660 131.639V125.848C642.484 127.516 624.6 126.09 607.61 121.63Z" fill="var(--rgba-primary-2)"></path>
			<path d="M582.826 33.1482C526.834 12.7023 465.17 32.0166 423.3 51.8218C401.757 62.0115 380.767 74.1017 360.47 85.7926C334.193 100.926 307.023 116.576 278.44 128.214C250.544 139.575 179.76 162.178 125.144 126.818C93.7245 106.478 71.8864 68.9508 60.2335 15.2801C59.1367 10.2298 58.1442 5.11891 57.1891 0H56C56.968 5.19672 57.9745 10.3877 59.0888 15.5169C70.8085 69.492 92.8139 107.26 124.498 127.772C179.588 163.439 250.821 140.701 278.891 129.271C307.547 117.602 334.754 101.932 361.064 86.7777C381.342 75.0983 402.311 63.0207 423.81 52.8515C465.475 33.1425 526.812 13.9105 582.417 34.2202C602.234 41.4569 620.307 53.4053 637.785 64.96C645.072 69.778 652.447 74.6429 660 79.2069V77.8625C652.678 73.4164 645.519 68.6899 638.44 64.0104C620.905 52.4202 602.774 40.433 582.826 33.1482Z" fill="var(--rgba-primary-2)"></path>
			</svg>

			<div class="blog-circle"></div>
		</section>
                                    <section class="content-inner bg-primary-light">
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-8 m-auto">
						<div class="accordion dz-accordion accordion-md" id="accordionFaq1">
							<div class="accordion-item">
								<h2 class="accordion-header" id="headingOne1">
									<a href="#" class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne1" aria-expanded="true" aria-controls="collapseOne1">
										YOGA TEACHER TRAINING
										<span class="toggle-close"></span>
									</a>
								</h2>
								<div id="collapseOne1" class="accordion-collapse collapse show" aria-labelledby="headingOne1" data-bs-parent="#accordionFaq1">
									<div class="accordion-body">
										<p class="m-b0" style="text-align: justify">Our carefully crafted, Yoga Alliance certified yoga teacher training in India take you on a spiritual journey within yourself.</p>
									</div>
								</div>
							</div>
							<div class="accordion-item">
								...
								<div id="collapseTwo1" class="accordion-collapse collapse" aria-labelledby="headingTwo1" data-bs-parent="#accordionFaq1">
									<div class="accordion-body">
										<p class="m-b0" style="text-align: justify">Aimed at being the finest yoga school in Varkala, India, our customized retreats allow you to enjoy a rejuvenating holiday in the lap of mother</p>
									</div>
								</div>
							</div>
							<div class="accordion-item">
								...
								<div id="collapseThree1" class="accordion-collapse collapse" aria-labelledby="headingThree1" data-bs-parent="#accordionFaq1">
									<div class="accordion-body">
										<p class="m-b0" style="text-align: justify">Learn the importance and techniques of Ayurveda from our highly qualified teachers at our splendidly located yoga school in Kerala.</p>
									</div>
								</div>
							</div>
						</div>
		...
		<div class="content-inner pt-md-5">
			<div class="container">
				<div class="row">
					<div class="col-xl-4 col-lg-4 m-b30">
						<aside class="sticky-top">
							...
							<div class="widget widget_working bg-primary m-b30 pb-3">
								<ul>
                                                                    <h5>Working Hours & Timings</h5>
									<li class="w-100 m-b20">
										<span class="days">Monday – Friday:</span>
										<span class="time"><a href="#!" style="color: white">07:00 – 21:00</a></span>
									</li>
                                                                        
									<li class="w-50 m-b20">
										
										<span class="days">Saturday:</span>
                                                                                <span class="time"><a href="#!" style="color: white">7am-6pm</a></span>
					...
					<div class="col-xl-8 col-lg-8">
						<div class="section-head m-0">
							...
							<h3 class="title">Why Do You Need Yoga?</h3>
						</div>
						<p style="text-align: justify">Originated in Ancient India, Yoga is a combination of mental, physical, and spiritual practices that have been known to improve quality of mental as well as physical health in human beings. Through the various courses offered by us in Rishikesh, Mysore, as well our Yoga school in Kerala, you would have a serene opportunity to replenish yourself with all the wellness that yoga has to offer.</p>	
