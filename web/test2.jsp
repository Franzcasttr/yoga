            ...
            <div class="section-full bg-white content-inner">
				<div class="container">
					<div class="section-head text-center">
						<span class="sub-title">PORTA VITAE MAURIS VEL</span>
						<h2 class="title m-b10">Don?t miss your chance to discover the most fascinating </h2>
						<p>Phasellus dolor risus, luctus at lorem eu, sollicitudin mollis leo. Pellentesque tincidunt vel tortor et cursus. Donec posuere risus vitae viverra cursus. Nunc porttitor pharetra</p>
					</div>
					<div class="row portfolio-bx" id="lightgallery">
						<div class="col-md-12 col-lg-6">
							<div class="dz-box m-b30">
								<div class="dz-thum dz-img-overlay1 overlay-primary"> 
									<img src="assets/images/service/media-1.jpg" alt="">
									<div class="overlay-bx">
										<div class="overlay-icon"> 
											<a href="https://www.youtube.com/watch?v=AFwMLBBjk7Y" class="icon-bx-xs rounded-xl popup-youtube"><i class="fa fa-play"></i></a> 
											<a href="error-404.html" data-src="assets/images/service/media-1.jpg" class="icon-bx-xs rounded-xl lg-item"><i class="flaticon-search"></i></a> 
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-md-6 col-lg-3 col-sm-6">
							<div class="dz-box m-b30">
								<div class="dz-thum dz-img-overlay1 overlay-primary"> 
									<img src="assets/images/portfolio/portfolio1/pic-4.jpg" alt="">
									<div class="overlay-bx">
										<div class="overlay-icon"> 
											<a href="https://www.youtube.com/watch?v=AFwMLBBjk7Y" class="icon-bx-xs rounded-xl popup-youtube"> <i class="fa fa-play "></i> </a> 
											<a href="error-404.html" data-src="assets/images/portfolio/portfolio1/pic-4.jpg" class="icon-bx-xs rounded-xl lg-item"><i class="flaticon-search"></i></a> 
										</div>
									</div>
								</div>
							</div>
							<div class="dz-box m-b30">
								<div class="dz-thum dz-img-overlay1 overlay-primary"> 
									<a href="javascript:void(0);"> <img src="assets/images/portfolio/portfolio1/pic-5.jpg" alt=""> </a>
									<div class="overlay-bx">
										<div class="overlay-icon"> 
											<a href="https://www.youtube.com/watch?v=AFwMLBBjk7Y" class="icon-bx-xs rounded-xl popup-youtube"> <i class="fa fa-play"></i> </a> 
											<a href="error-404.html" data-src="assets/images/portfolio/portfolio1/pic-5.jpg" class="icon-bx-xs rounded-xl lg-item"><i class="flaticon-search"></i></a> 
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-md-6 col-lg-3 col-sm-6">
							<div class="dz-box m-b30">
								<div class="dz-thum dz-img-overlay1 overlay-primary"> 
									<a href="javascript:void(0);"> <img src="assets/images/portfolio/portfolio1/pic-6.jpg" alt=""> </a>
									<div class="overlay-bx">
										<div class="overlay-icon"> 
											<a href="https://www.youtube.com/watch?v=AFwMLBBjk7Y" class="icon-bx-xs rounded-xl popup-youtube"> <i class="fa fa-play"></i> </a> 
											<a href="error-404.html" data-src="assets/images/portfolio/portfolio1/pic-6.jpg" class="icon-bx-xs rounded-xl lg-item"><i class="flaticon-search"></i></a> 
										</div>
									</div>
								</div>
							</div>
							<div class="dz-box m-b30">
								<div class="dz-thum dz-img-overlay1 overlay-primary"> 
									<a href="javascript:void(0);"> <img src="assets/images/portfolio/portfolio1/pic-7.jpg" alt=""> </a>
									<div class="overlay-bx">
										<div class="overlay-icon"> 
											<a href="https://www.youtube.com/watch?v=AFwMLBBjk7Y" class="icon-bx-xs rounded-xl popup-youtube"> <i class="fa fa-play"></i> </a> 
											<a href="error-404.html" data-src="assets/images/portfolio/portfolio1/pic-7.jpg" class="icon-bx-xs rounded-xl lg-item"><i class="flaticon-search"></i></a> 
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-md-6 col-lg-6 col-sm-6">
							<div class="dz-box m-b30">
								<div class="dz-thum dz-img-overlay1 overlay-primary"> 
									<a href="javascript:void(0);"> <img src="assets/images/portfolio/portfolio1/pic-3.jpg" alt=""> </a>
									<div class="overlay-bx">
										<div class="overlay-icon"> 
											<a href="https://www.youtube.com/watch?v=AFwMLBBjk7Y" class="icon-bx-xs rounded-xl popup-youtube"> <i class="fa fa-play"></i> </a> 
											<a href="error-404.html" data-src="assets/images/portfolio/portfolio1/pic-3.jpg" class="icon-bx-xs rounded-xl lg-item"><i class="flaticon-search"></i></a> 
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-md-6 col-lg-6 col-sm-6">
							<div class="dz-box m-b30">
								<div class="dz-thum dz-img-overlay1 overlay-primary"> 
									<a href="portfolio.html"> <img src="assets/images/portfolio/portfolio1/pic-2.jpg" alt=""> </a>
									<div class="overlay-bx">
										<div class="overlay-icon"> 
											<a href="https://www.youtube.com/watch?v=AFwMLBBjk7Y" class="icon-bx-xs rounded-xl popup-youtube"> <i class="fa fa-play"></i> </a> 
											<a href="error-404.html" data-src="assets/images/portfolio/portfolio1/pic-2.jpg" class="icon-bx-xs rounded-xl lg-item"><i class="flaticon-search"></i></a> 
										</div>
									</div>
								</div>
							</div>
