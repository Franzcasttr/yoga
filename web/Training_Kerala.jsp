		...
		<div class="dz-bnr-inr style-1 text-center">
			<div class="container">
				<div class="dz-bnr-inr-entry">
					<h1>200 Hour Yoga Teacher Training In Kerala</h1>
					<!-- Breadcrumb Row -->
					<nav aria-label="breadcrumb" class="breadcrumb-row">
						<ul class="breadcrumb">
							<li class="breadcrumb-item"><a href="Home">Home</a></li>
							<li class="breadcrumb-item active" aria-current="page">200 Hour Yoga Teacher Training In Kerala</li>
						</ul>
					</nav>
					<!-- Breadcrumb Row End -->
				</div>
		...
		<div class="content-inner">
				...
				<div class="row">
					<div class="col-xl-4 col-lg-4 m-b30">
						<aside class="side-bar left sticky-top">
                            <div class="widget service_menu_nav">
								<ul>
									<li ><a href="Training_Rishikesh">200 Hour Yoga Teacher Training In Rishikesh</a> </li>
									<li class="active"><a href="Training_Kerala">200 Hour Yoga Teacher Training In Kerala</a></li>
					...
					<div class="col-xl-8 col-lg-8">
						...
						<div class="dz-content">
							<div class="m-b40">
								<h3 class="title">200 Hour Yoga Teacher Training In Kerala</h3>
                                                                <div class="dz-separator style-3">
								<img src="assets/images/lotus.svg" alt="">
							</div>
								<p>The 200-hour yoga teacher training course with us is all about deepening your practice and gaining confidence so that you can share it with the rest of the world. This course is designed for all those people who are ready to commit themselves to the path of Yoga and who are seeking inner transformation in their lives. Yoga Alliance Approved Yoga teacher training program by Pankaj Yogpeeth is a wonderful opportunity to achieve their desired goal happily and peacefully. At the same time, this course will help you to establish your career in Yoga as a wonderful teacher</p>
							</div>
			...
			<div class="container">
				<div class="section-head style-1 text-center">
					<h5 class="title wow fadeInUp" data-wow-delay="0.2s">Upcoming Yoga Courses</h5>
					<div class="dz-separator style-3">
								<img src="assets/images/lotus.svg" alt="">
							</div>
				</div>
					...
					<div class="swiper-wrapper">
						<div class="swiper-slide wow fadeInUp" data-wow-delay="0.2s">
							<div class="dz-card style-1 green overlay-shine">
								<div class="dz-media">
                                                                    <a href="blog-details.html"><img src="img/course/c1.jpg" alt=""></a>
								</div>
								<div class="dz-info">
									
									
									<h4 class="dz-title"><a href="blog-details.html">100 Hours Yoga Teacher Training in Rishikesh - October 2023</a></h4>
									<div class="dz-meta">
										<ul>
											<li class="post-date">
											...
											<li class="post-time">
												<a href="javascript:void(0);"> 
													...
													<span>DATE: 1th October - 28th October</span>
												</a>
											</li>
									...
									<a href="blog-details.html" class="btn btn-primary">Reserve Now</a>
								</div>
							</div>
						</div>
						<div class="swiper-slide wow fadeInUp" data-wow-delay="0.4s">
							<div class="dz-card style-1 green overlay-shine">
								<div class="dz-media">
                                                                    <a href="blog-details.html"><img src="img/course/c2.jpg" alt=""></a>
								</div>
								<div class="dz-info">
									
									
									<h4 class="dz-title"><a href="blog-details.html">300 Hour Yoga Teacher Training in Rishikesh - October 2023</a></h4>
									<div class="dz-meta">
										<ul>
											<li class="post-date">
												<a href="javascript:void(0);">
						...
						<div class="swiper-slide wow fadeInUp" data-wow-delay="0.6s">
							<div class="dz-card style-1 green overlay-shine">
								<div class="dz-media">
                                                                    <a href="blog-details.html"><img src="img/course/c3.jpg" alt=""></a>
								</div>
								<div class="dz-info">
									
									
									<h4 class="dz-title"><a href="blog-details.html">200 Hour Yoga Teacher Training in Rishikesh - October 2023</a></h4>
									<div class="dz-meta">
										<ul>
											<li class="post-date">
												<a href="javascript:void(0);">
											...
											<li class="post-time">
												<a href="javascript:void(0);"> 
													<i class="flaticon-calendar"></i>
													<span>DATE: 4th October - 27th October</span>
												</a>
											</li>
							...
							<div class="accordion-item">
								...
								<div id="collapseOne1" class="accordion-collapse collapse show" aria-labelledby="headingOne1" data-bs-parent="#accordionFaq1">
									<div class="accordion-body">
										<p class="m-b0">Our carefully crafted, Yoga Alliance certified yoga teacher training in India take you on a spiritual journey within yourself.</p>
									</div>
								</div>
							</div>
							<div class="accordion-item">
								...
								<div id="collapseTwo1" class="accordion-collapse collapse" aria-labelledby="headingTwo1" data-bs-parent="#accordionFaq1">
									<div class="accordion-body">
										<p class="m-b0">Aimed at being the finest yoga school in Varkala, India, our customized retreats allow you to enjoy a rejuvenating holiday in the lap of mother</p>
									</div>
								</div>
							</div>
							<div class="accordion-item">
								...
								<div id="collapseThree1" class="accordion-collapse collapse" aria-labelledby="headingThree1" data-bs-parent="#accordionFaq1">
									<div class="accordion-body">
										<p class="m-b0">Learn the importance and techniques of Ayurveda from our highly qualified teachers at our splendidly located yoga school in Kerala.</p>
									</div>
								</div>
							</div>
						</div>
			...
			<div class="container">
				<div class="row">
							...
							<div class="widget widget_working bg-primary m-b30 pb-3">
								<ul>
									...
									<li class="w-100 m-b20">
										...
										<span class="time"><a href="schedule.html" style="color: white">07:00 – 21:00</a></span>
									</li>
                                                                        
									<li class="w-50 m-b20">
										
										<span class="days">Saturday:</span>
                                                                                <span class="time"><a href="schedule.html" style="color: white">7am-6pm</a></span>
					...
					<div class="col-xl-8 col-lg-8">
						...
						<p>Originated in Ancient India, Yoga is a combination of mental, physical, and spiritual practices that have been known to improve quality of mental as well as physical health in human beings. Through the various courses offered by us in Rishikesh, Mysore, as well our Yoga school in Kerala, you would have a serene opportunity to replenish yourself with all the wellness that yoga has to offer.</p>	
