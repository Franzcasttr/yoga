...
<div class="page-wraper">
				...
				<div class="container clearfix">
					...
					<div class="extra-nav">
						<div class="extra-cell">
							<a href="login.html" class="btn btn-primary">Try For Free</a>
						</div>
					</div>
					<!-- Extra Nav -->
						...
						<ul class="nav navbar-nav navbar navbar-left">
							...
							<li class="sub-menu-down"><a href="javascript:void(0);">Pages</a>
								<ul class="sub-menu">
									...
									<li><a href="javascript:void(0);">Login <i class="fa fa-angle-right"></i></a>
										<ul class="sub-menu">
									...
									<li><a href="javascript:void(0);">Portfolio <i class="fa fa-angle-right"></i></a>
										<ul class="sub-menu">
											<li><a href="portfolio.html">Portfolio</a></li>
											<li><a href="slider-showcase.html">Portfolio Slider</a></li>
										</ul>
									</li>
									<li><a href="javascript:void(0);">Courses <i class="fa fa-angle-right"></i></a>
										<ul class="sub-menu">
									...
									<li><a href="javascript:void(0);">Polices <i class="fa fa-angle-right"></i></a>
										<ul class="sub-menu">
							...
							<li class="sub-menu-down"><a href="javascript:void(0);">Events</a>
								<ul class="sub-menu">
							...
							<li class="sub-menu-down"><a href="javascript:void(0);">Blog</a>
								<ul class="sub-menu">
									...
									<li><a href="blog-grid-overlay.html">Blog Grid Overlay</a></li>
								...
								<ul class="mega-menu">
									<li> <a href="javascript:;">Element</a>
										<ul>
											...
											<li><a href="shortcode-alert.html"><i class="ti-alert"></i> Alert box</a></li>
											...
											<li><a href="shortcode-buttons-effects.html"><i class="ti-mouse"></i> Buttons Effects</a></li>
									...
									<li> <a href="javascript:;">Element</a>
										<ul>
											...
											<li><a href="shortcode-widgets.html"><i class="ti-widgetized"></i> All Widgets</a></li>
											<li><a href="shortcode-google-map.html"><i class="ti-map-alt"></i>Google Maps</a></li>
									...
									<li> <a href="javascript:;">Element</a>
										<ul>
											...
											<li><a href="shortcode-progress-bars.html"><i class="ti-view-list"></i> Progress Bars</a></li>
											<li><a href="shortcode-separators.html"><i class="ti-layout-line-solid"></i> Separators</a></li>
										</ul>
									</li>
									<li> <a href="javascript:;">Element</a>
										<ul>
											<li><a href="shortcode-sliders.html"><i class="ti-layout-slider"></i>Sliders</a></li>											
											...
											<li><a href="shortcode-typography.html"><i class="ti-map-alt"></i> Typography</a></li>
											<li><a href="shortcode-widgets.html"><i class="ti-widgetized"></i> Widgets</a></li>
										</ul>
									</li>
								</ul>
							</li>
	...
	<div class="page-content bg-white">
				...
				<div class="dz-bnr-inr-entry">
					...
					<nav aria-label="breadcrumb" class="breadcrumb-row">
						<ul class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page">Gallery filters</li>
						</ul>
					</nav>
					<!-- Breadcrumb Row End -->
				</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12 text-center">
						<h4 class="m-b20">Filters Style 1</h4>
						<div class="site-filters style-1 clearfix m-b20">
							<ul class="filters filters1" data-bs-toggle="buttons">
								...
								<li data-filter=".Music" class="btn"><input type="radio"><a href="javascript:void(0);"><span>Music</span></a></li>
								...
								<li data-filter=".Entertainment" class="btn"><input type="radio"><a href="javascript:void(0);"><span>Entertainment</span></a></li>
								<li data-filter=".Yoga" class="btn"><input type="radio"><a href="javascript:void(0);"><span>Yoga</span></a></li>
							</ul>
						</div>
					</div>
				</div>
				<div class="clearfix" id="lightgallery">
					<ul id="masonry1" class="dlab-gallery-listing gallery-grid-8 sp10 gallery text-center">
						<li class="card-container m-b10 col-lg-3 Nature">
							<a href="error-404.html" data-src="assets/images/filter/pic1.jpg" class="dz-media dz-img-overlay7 rounded lg-item">
								<img src="assets/images/filter/pic1.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Entertainment">
							<a href="error-404.html" data-src="assets/images/filter/pic9.jpg" class="dz-media dz-img-overlay7 rounded lg-item">
								<img src="assets/images/filter/pic9.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Entertainment Music">
							<a href="error-404.html" data-src="assets/images/filter/pic10.jpg" class="dz-media dz-img-overlay7 rounded lg-item">
								<img src="assets/images/filter/pic10.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Yoga">
							<a href="error-404.html" data-src="assets/images/filter/pic16.jpg" class="dz-media dz-img-overlay7 rounded lg-item">
								<img src="assets/images/filter/pic16.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Nature">
							<a href="error-404.html" data-src="assets/images/filter/pic4.jpg" class="dz-media dz-img-overlay7 rounded lg-item">
								<img src="assets/images/filter/pic4.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Woman">
							<a href="error-404.html" data-src="assets/images/filter/pic5.jpg" class="dz-media dz-img-overlay7 rounded lg-item">
								<img src="assets/images/filter/pic5.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Man">
							<a href="error-404.html" data-src="assets/images/filter/pic3.jpg" class="dz-media dz-img-overlay7 rounded lg-item">
								<img src="assets/images/filter/pic3.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Nature">
							<a href="error-404.html" data-src="assets/images/filter/pic2.jpg" class="dz-media dz-img-overlay7 rounded lg-item">
								<img src="assets/images/filter/pic2.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Man">
							<a href="error-404.html" data-src="assets/images/filter/pic7.jpg" class="dz-media dz-img-overlay7 rounded lg-item">
								<img src="assets/images/filter/pic7.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Entertainment">
							<a href="error-404.html" data-src="assets/images/filter/pic10.jpg" class="dz-media dz-img-overlay7 rounded lg-item">
						...
						<li class="card-container m-b10 col-lg-3 Woman">
							<a href="error-404.html" data-src="assets/images/filter/pic8.jpg" class="dz-media dz-img-overlay7 rounded lg-item">
								<img src="assets/images/filter/pic8.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Entertainment Music">
							<a href="error-404.html" data-src="assets/images/filter/pic11.jpg" class="dz-media dz-img-overlay7 rounded lg-item">
								<img src="assets/images/filter/pic11.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Woman">
							<a href="error-404.html" data-src="assets/images/filter/pic14.jpg" class="dz-media dz-img-overlay7 rounded lg-item">
								<img src="assets/images/filter/pic14.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Entertainment">
							<a href="error-404.html" data-src="assets/images/filter/pic12.jpg" class="dz-media dz-img-overlay7 rounded lg-item">
								<img src="assets/images/filter/pic12.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Entertainment Music">
							<a href="error-404.html" data-src="assets/images/filter/pic13.jpg" class="dz-media dz-img-overlay7 rounded lg-item">
								<img src="assets/images/filter/pic13.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Yoga">
							<a href="error-404.html" data-src="assets/images/filter/pic15.jpg" class="dz-media dz-img-overlay7 rounded lg-item">
								<img src="assets/images/filter/pic15.jpg" alt="/" width="800" height="650">
							</a>
						</li>
					</ul>
				</div>
		...
		<!-- Gallery-filter-2 -->
		<section class="content-inner-1 bg-dark">
			<div class="container">
				<div class="row">
					<div class="col-lg-12 text-center">
						<h4 class="m-b30 text-white">Filters Style 2</h4>
						<div class="site-filters style-2 clearfix m-b20">
							<ul class="filters filters2" data-bs-toggle="buttons">
								<li data-filter="" class="btn active"><input type="radio"><a href="javascript:void(0);"><span>All</span></a></li>
								<li data-filter=".Nature" class="btn"><input type="radio"><a href="javascript:void(0);"><span>Nature</span></a></li>
								<li data-filter=".Music" class="btn"><input type="radio"><a href="javascript:void(0);"><span>Music</span></a></li>
								<li data-filter=".Woman" class="btn"><input type="radio"><a href="javascript:void(0);"><span>Woman</span></a></li>
				...
				<div class="clearfix" id="lightgallery2">
					<ul id="masonry2" class="dlab-gallery-listing gallery-grid-8 sp10 gallery text-center">
						<li class="card-container m-b10 col-lg-3 Nature">
							<a href="error-404.html" data-src="assets/images/filter/pic1.jpg" class="dz-media dz-img-overlay5 rounded lg-item">
								<img src="assets/images/filter/pic1.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Entertainment">
							<a href="error-404.html" data-src="assets/images/filter/pic9.jpg" class="dz-media dz-img-overlay5 rounded lg-item">
								<img src="assets/images/filter/pic9.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Entertainment Music">
							<a href="error-404.html" data-src="assets/images/filter/pic10.jpg" class="dz-media dz-img-overlay5 rounded lg-item">
								<img src="assets/images/filter/pic10.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Yoga">
							<a href="error-404.html" data-src="assets/images/filter/pic16.jpg" class="dz-media dz-img-overlay5 rounded lg-item">
								<img src="assets/images/filter/pic16.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Nature">
							<a href="error-404.html" data-src="assets/images/filter/pic4.jpg" class="dz-media dz-img-overlay5 rounded lg-item">
								<img src="assets/images/filter/pic4.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Woman">
							<a href="error-404.html" data-src="assets/images/filter/pic5.jpg" class="dz-media dz-img-overlay5 rounded lg-item">
								<img src="assets/images/filter/pic5.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Man">
							<a href="error-404.html" data-src="assets/images/filter/pic3.jpg" class="dz-media dz-img-overlay5 rounded lg-item">
								<img src="assets/images/filter/pic3.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Nature">
							<a href="error-404.html" data-src="assets/images/filter/pic2.jpg" class="dz-media dz-img-overlay5 rounded lg-item">
								<img src="assets/images/filter/pic2.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Man">
							<a href="error-404.html" data-src="assets/images/filter/pic7.jpg" class="dz-media dz-img-overlay5 rounded lg-item">
								<img src="assets/images/filter/pic7.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Entertainment">
						...
						<li class="card-container m-b10 col-lg-3 Woman">
							<a href="error-404.html" data-src="assets/images/filter/pic8.jpg" class="dz-media dz-img-overlay5 rounded lg-item">
								<img src="assets/images/filter/pic8.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Entertainment Music">
							<a href="error-404.html" data-src="assets/images/filter/pic11.jpg" class="dz-media dz-img-overlay5 rounded lg-item">
								<img src="assets/images/filter/pic11.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Woman">
							<a href="error-404.html" data-src="assets/images/filter/pic14.jpg" class="dz-media dz-img-overlay5 rounded lg-item">
								<img src="assets/images/filter/pic14.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Entertainment">
							<a href="error-404.html" data-src="assets/images/filter/pic12.jpg" class="dz-media dz-img-overlay5 rounded lg-item">
								<img src="assets/images/filter/pic12.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Entertainment Music">
							<a href="error-404.html" data-src="assets/images/filter/pic13.jpg" class="dz-media dz-img-overlay5 rounded lg-item">
								<img src="assets/images/filter/pic13.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Yoga">
							<a href="error-404.html" data-src="assets/images/filter/pic15.jpg" class="dz-media dz-img-overlay5 rounded lg-item">
								<img src="assets/images/filter/pic15.jpg" alt="/" width="800" height="650">
							</a>
						</li>
					</ul>
		...
		<section class="content-inner-1">
			<div class="container">
				<div class="row">
					<div class="col-lg-12 text-center">
						<h4 class="m-b20">Filters Style 3</h4>
						<div class="site-filters style-3 clearfix m-b20">
							<ul class="filters filters3" data-bs-toggle="buttons">
								<li data-filter="" class="btn active"><input type="radio"><a href="javascript:void(0);"><span>All</span></a></li>
								<li data-filter=".Nature" class="btn"><input type="radio"><a href="javascript:void(0);"><span>Nature</span></a></li>
								<li data-filter=".Music" class="btn"><input type="radio"><a href="javascript:void(0);"><span>Music</span></a></li>
								<li data-filter=".Woman" class="btn"><input type="radio"><a href="javascript:void(0);"><span>Woman</span></a></li>
				...
				<div class="clearfix" id="lightgallery3">
					<ul id="masonry3" class="dlab-gallery-listing gallery-grid-8 sp10 gallery text-center">
						<li class="card-container m-b10 col-lg-3 Nature">
							<a href="error-404.html" data-src="assets/images/filter/pic1.jpg" class="dz-media dz-img-overlay4 rounded lg-item">
								<img src="assets/images/filter/pic1.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Entertainment">
							<a href="error-404.html" data-src="assets/images/filter/pic9.jpg" class="dz-media dz-img-overlay4 rounded lg-item">
								<img src="assets/images/filter/pic9.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Entertainment Music">
							<a href="error-404.html" data-src="assets/images/filter/pic10.jpg" class="dz-media dz-img-overlay4 rounded lg-item">
								<img src="assets/images/filter/pic10.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Yoga">
							<a href="error-404.html" data-src="assets/images/filter/pic16.jpg" class="dz-media dz-img-overlay4 rounded lg-item">
								<img src="assets/images/filter/pic16.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Nature">
							<a href="error-404.html" data-src="assets/images/filter/pic4.jpg" class="dz-media dz-img-overlay4 rounded lg-item">
								<img src="assets/images/filter/pic4.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Woman">
							<a href="error-404.html" data-src="assets/images/filter/pic5.jpg" class="dz-media dz-img-overlay4 rounded lg-item">
								<img src="assets/images/filter/pic5.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Man">
							<a href="error-404.html" data-src="assets/images/filter/pic3.jpg" class="dz-media dz-img-overlay4 rounded lg-item">
								<img src="assets/images/filter/pic3.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Nature">
							<a href="error-404.html" data-src="assets/images/filter/pic2.jpg" class="dz-media dz-img-overlay4 rounded lg-item">
								<img src="assets/images/filter/pic2.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Man">
							<a href="error-404.html" data-src="assets/images/filter/pic7.jpg" class="dz-media dz-img-overlay4 rounded lg-item">
								<img src="assets/images/filter/pic7.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Entertainment">
						...
						<li class="card-container m-b10 col-lg-3 Woman">
							<a href="error-404.html" data-src="assets/images/filter/pic8.jpg" class="dz-media dz-img-overlay4 rounded lg-item">
								<img src="assets/images/filter/pic8.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Entertainment Music">
							<a href="error-404.html" data-src="assets/images/filter/pic11.jpg" class="dz-media dz-img-overlay4 rounded lg-item">
								<img src="assets/images/filter/pic11.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Woman">
							<a href="error-404.html" data-src="assets/images/filter/pic14.jpg" class="dz-media dz-img-overlay4 rounded lg-item">
								<img src="assets/images/filter/pic14.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Entertainment">
							<a href="error-404.html" data-src="assets/images/filter/pic12.jpg" class="dz-media dz-img-overlay4 rounded lg-item">
								<img src="assets/images/filter/pic12.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Entertainment Music">
							<a href="error-404.html" data-src="assets/images/filter/pic13.jpg" class="dz-media dz-img-overlay4 rounded lg-item">
								<img src="assets/images/filter/pic13.jpg" alt="/" width="800" height="650">
							</a>
						</li>
						<li class="card-container m-b10 col-lg-3 Yoga">
							<a href="error-404.html" data-src="assets/images/filter/pic15.jpg" class="dz-media dz-img-overlay4 rounded lg-item">
								<img src="assets/images/filter/pic15.jpg" alt="/" width="800" height="650">
							</a>
						</li>
					</ul>
		...
		<section class="content-inner-1 bg-dark">
			<div class="container">
				<div class="row">
					<div class="col-lg-12 text-center">
						<h4 class="m-b20 text-white">Filters Style 4</h4>
						<div class="site-filters style-4 clearfix m-b20">
							<ul class="filters filters4" data-bs-toggle="buttons">
								<li data-filter="" class="btn active"><input type="radio"><a href="javascript:void(0);"><span>All</span></a></li>
								<li data-filter=".Nature" class="btn"><input type="radio"><a href="javascript:void(0);"><span>Nature</span></a></li>
								<li data-filter=".Music" class="btn"><input type="radio"><a href="javascript:void(0);"><span>Music</span></a></li>
								<li data-filter=".Woman" class="btn"><input type="radio"><a href="javascript:void(0);"><span>Woman</span></a></li>
				...
				<div class="clearfix" id="lightgallery4">
					<ul id="masonry4" class="dlab-gallery-listing gallery-grid-8 sp10 gallery text-center">
						<li class="card-container m-b10 col-lg-3 Nature">
							<a href="error-404.html" data-src="assets/images/filter/pic1.jpg" class="dz-media dz-img-overlay4 rounded lg-item">
								<img src="assets/images/filter/pic1.jpg" alt="/" width="800" height="650">
							</a>
		...
		<section class="content-inner-1">
			<div class="container">
				<div class="row">
					<div class="col-lg-12 text-center">
						<h4 class="m-b20">Filters Style 5</h4>
						<div class="site-filters style-5 clearfix m-b20">
							<ul class="filters filters5" data-bs-toggle="buttons">
								<li data-filter="" class="btn active"><input type="radio"><a href="javascript:void(0);"><span>All</span></a></li>
								<li data-filter=".Nature" class="btn"><input type="radio"><a href="javascript:void(0);"><span>Nature</span></a></li>
								<li data-filter=".Music" class="btn"><input type="radio"><a href="javascript:void(0);"><span>Music</span></a></li>
								<li data-filter=".Woman" class="btn"><input type="radio"><a href="javascript:void(0);"><span>Woman</span></a></li>
	...
	<!-- Footer -->
    <footer class="site-footer bg-img-fix footer-action" style="background-image: url(assets/images/background/footer-bg.png);" id="footer">
				...
				<div class="row">
					...
					<div class="col-xl-4 col-lg-2">
						<div class="footer-logo logo-center">
							<a href="index.html"><img src="assets/images/logo-center.png" alt="logo"></a>
						</div>
					</div>
					...
					<div class="col-xl-12">
						<div class="footer-menu">
							<ul class="">
								...
								<li><a href="portfolio.html">PORTFOLIO</a></li>
								<li><a href="error-404.html">BLOG</a></li>
								<li><a href="team.html">TEAM</a></li>
							</ul>
						</div>
					</div>
