<%-- 
    Document   : YogaRetreatNepal
    Created on : 30 Jul, 2023, 11:55:40 AM
    Author     : nandy
--%>

<%-- 
    Document   : YogaRetreatKerala
    Created on : 30 Jul, 2023, 11:52:21 AM
    Author     : nandy
--%>

<%-- 
    Document   : YogaRetreatRishikesh
    Created on : 29 Jul, 2023, 10:25:59 PM
    Author     : nandy
--%>
		...
		<div class="dz-bnr-inr style-1 text-center">
			<div class="container">
				<div class="dz-bnr-inr-entry">
					<h1>Yoga Retreat Nepal</h1>
					<!-- Breadcrumb Row -->
					<nav aria-label="breadcrumb" class="breadcrumb-row">
						<ul class="breadcrumb">
							<li class="breadcrumb-item"><a href="index.html">Home</a></li>
							<li class="breadcrumb-item active" aria-current="page">Yoga Retreat Nepal</li>
						</ul>
					</nav>
					<!-- Breadcrumb Row End -->
				</div>
				...
				<div class="row">
					<div class="col-xl-4 col-lg-4 m-b30">
						<aside class="sticky-top">
							<div class="yoga-media rounded-md m-b30">
                                                            <img src="img/yogaretreat/yogaretreat.jpg" class="rounded-md" alt="">
							</div>
					...
					<div class="col-xl-8 col-lg-8">
						<div class="section-head m-0">
							<h3>HOLISTIC RETREATS IN INDIA - THE BIRTHPLACE OF YOGA AND AYURVEDA</h3>
							
						</div>
						<p>'Samarpana' literally translates to the ability to 'surrender' oneself. And, at Samarpana Yogshala, we believe that the truest form of learning the wellness of yoga and Ayurveda is attained when we willfully surrender ourselves to the discipline and to the gurus who guide us through this journey of self-discovery and mind, body, soul harmony. Undoubtedly, one of the best yoga retreats in India, our courses are crafted to allow you to submit yourself, mentally, emotionally, and physically to the practices of yoga and Ayurveda. Our highly revered gurus, with their years of practice and expertise, aim at instilling the significance and habit of abhyasa - 'the art of practicing'. At Samarpana Yogshala, we understand that life today has become extremely hectic and demanding. And, we recognize why it is important for all of us to take a rejuvenation break once in a while. That is why, we have specially designed our Ayurveda retreats in Kerala and other picturesque locations in India, including Rishikesh and Mysore. Unlike several other yoga schools in the world, we don't believe in going through the yogic studies just for obtaining a certificate. Instead, we motivate and inspire our students to experience yoga as a whole process - psychologically, physically, as well as spiritually. At our yoga retreat in Varkala as well as other locations in the country, our main aim is to create a tranquil yet productive environment where students can embrace the yogic life and at the same time get a chance to unwind themselves. So, come join us as we take you through a transformative voyage into your inner self and get an opportunity to cherish the wellness offered at one of the best yoga holidays in India.</p>	
                            ...
                            <div class="row">
						<div class="section-head m-0">
                                                    <center><h4>VENUES AND ACCOMODATION</h4></center>
							
						</div>
                                <div class="col-md-6">
						<p>Rishikesh Green View Cloud Ayurvedic Centre,Varkala At Samarpana Yogshala, we believe that the ambience is as important as the dedication when you wish to learn the disciplines of Yoga. This is why, we choose all our locations very thoughtfully. Our Yoga Retreat in Kerala, Green View Cloud Ayurvedic Center is located in the heart of Varkala - a beach town famous for its serene landscape and tranquility. The best beach resort in the area, our center offers spacious and well-appointed rooms with ensuite bathrooms. The rooms are scattered over two floors, however, to make it easier for students with limited mobility, we offer them priority to choose ground floor rooms.</p>	
                                                </div>
                                <div class="col-lg-6">
						<ul class="list-check list-box">
							<li>
								<i class="flaticon-power text-secondary"></i>
								2019 Retreat Calendar 10 Days Yoga and Ayurveda Retreat, Varkala,Rishikesh 2019 Date : November 15 to November 24 Duration :
                                                                10 Days (9 Nights) Price : USD 695 - <a href="" class="btn btn-sm btn-primary m-r15 m-b15" style="color:white">Reserve Now</a>
							</li>
							<li>
								<i class="flaticon-power text-secondary"></i>
								2020 Retreat Calendar 10 Days Yoga and Ayurveda Retreat, Varkala,Rishikesh 2020 Date : January 15th to January 24th Duration :
                                                                10 Days (9 Nights) Price : USD 695 - <a href="" class="btn btn-sm btn-primary m-r15 m-b15" style="color:white">Reserve Now</a>
							</li>
						...
						<hr>
                            <div class="clearfix">
                                <center><h3 class="title m-b20">RETREAT VENUE IMAGES</h3></center>
							<div class="row">
								<div class="col-md-6 m-b30">
									<div class="dz-card style-1 overlay-shine">
										<div class="dz-media">
											<a href="blog-details.html"><img src="assets/images/class/pic-1.jpg" alt=""></a>
										</div>
										<div class="dz-info">
											<div class="post-author"><img src="assets/images/testimonials/pic1.jpg" alt=""></div>
											<a href="blog-details.html" class="text-secondary post-category">Vinyasa</a>
											<h4 class="dz-title"><a href="blog-details.html">Power Vinyasa</a></h4>
											<div class="dz-meta">
												<ul>
													<li class="post-date">
														<a href="javascript:void(0);">
															<i class="flaticon-calendar"></i>
															<span>Open: 13 Jan 2023</span>
														</a>
													</li>
													<li class="post-time">
														<a href="javascript:void(0);"> 
											...
											<p>It is a long fact that a reader will be distracted by the readable.</p>
											<a href="personal-training.html" class="btn btn-primary">Learn More</a>
										</div>
									</div>
								</div>
								<div class="col-md-6 m-b30">
									<div class="dz-card style-1 overlay-shine">
										<div class="dz-media">
											<a href="blog-details.html"><img src="assets/images/class/pic-2.jpg" alt=""></a>
										</div>
										<div class="dz-info">
											<div class="post-author"><img src="assets/images/testimonials/pic2.jpg" alt=""></div>
											<a href="blog-details.html" class="text-secondary post-category">Padmasana</a>
											<h4 class="dz-title"><a href="blog-details.html">Iyengar Yoga</a></h4>
											<div class="dz-meta">
												<ul>
													<li class="post-date">
														<a href="javascript:void(0);">
															<i class="flaticon-calendar"></i>
															<span>Open: 27 Nov 2023</span>
														</a>
													</li>
													<li class="post-time">
														<a href="javascript:void(0);"> 
