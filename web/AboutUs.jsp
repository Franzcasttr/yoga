					...
					<div class="col-lg-6 col-md-12">
						<div class="section-head me-lg-2 text-lg-start text-center">
							...
							<h2 class="title">About Us</h2>
                                                        <p>At samarpan yogashala we help people to create union between body, mind and spirit with self and universal consciousness, which results in evenness in your life. We aim at providing traditional yoga teacher training courses in India which is SAFE driven and all our courses are Yoga Alliance USA certified. The main intention of starting samarpana yogshala is to share the experience we received from our teachers across the globe. </p>
                                                        <p>We aim at providing quality services to our people with affordable price, so that more people can come and reap the benefits of yoga, to spread all over the world. 
You will study yoga with the best Indian yoga teachers, at affordable price, because what we want for our students is the best quality and best results. 
 </p>
                                                        <p>( in this part add some pictures and make them bigger if possible. Underline key words like the name of the school and others like USA Certified, affordable prices, Indian teachers, etc) </p>
						</div>
					</div>
				</div>
