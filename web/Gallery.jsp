...
<div class="page-wraper">
	...
	<div class="page-content bg-white">
		...
		<div class="content-block">
            <div class="section-full bg-white content-inner">
				<div class="container">
					<div class="section-head text-center">
                                            <span class="sub-title">Gallery</span><br>
					...
					<div class="row portfolio-bx" id="lightgallery">
						...
						<div class="col-md-6 col-lg-3 col-sm-6">
							...
							<div class="dz-box m-b30">
								<div class="dz-thum dz-img-overlay1 overlay-primary"> 
                                                                    <a href="javascript:void(0);"> <img src="img/gal/g1.jpg" alt=""> </a>
									<div class="overlay-bx">
						...
						<div class="col-md-6 col-lg-3 col-sm-6">
							<div class="dz-box m-b30">
								<div class="dz-thum dz-img-overlay1 overlay-primary"> 
                                                                    <a href="javascript:void(0);"> <img src="img/gal/g4.jpg" alt=""> </a>
									<div class="overlay-bx">
							...
							<div class="dz-box m-b30">
								<div class="dz-thum dz-img-overlay1 overlay-primary"> 
                                                                    <a href="javascript:void(0);"> <img src="img/gal/g5.jpg" alt=""> </a>
									<div class="overlay-bx">
                                    ...
                                    <%----------------------------------------------------------------------------%>
                                    <section class="portfolio-wrapper content-inner">
						...
						<div class="swiper-wrapper">
							<div class="swiper-slide wow fadeInUp" data-wow-delay="0.1s">
								<div class="dz-box box-1 style-1">
									<div class="dz-media">
                                                                            <a href="portfolio.html"><img src="img/pic/yoga1.jpeg" alt=""></a>
									</div>
									
								</div>
							</div>
							<div class="swiper-slide wow fadeInUp" data-wow-delay="0.2s">
								<div class="dz-box box-2 style-1">
									<div class="dz-media">
                                                                            <a href="portfolio.html"><img src="img/pic/yoga2.jpeg" alt=""></a>
									</div>
							...
							<div class="swiper-slide wow fadeInUp" data-wow-delay="0.4s">
								<div class="dz-box box-1 style-1">
									<div class="dz-media">
                                                                            <a href="portfolio.html"><img src="img/pic/yoga3.jpeg" alt=""></a>
									</div>
							...
							<div class="swiper-slide wow fadeInUp" data-wow-delay="0.6s">
								<div class="dz-box box-2 style-1">
									<div class="dz-media">
                                                                            <a href="portfolio.html"><img src="img/pic/yoga4.jpeg" alt=""></a>
									</div>
							...
							<div class="swiper-slide wow fadeInUp" data-wow-delay="0.8s">
								<div class="dz-box box-1 style-1">
									<div class="dz-media">
                                                                            <a href="portfolio.html"><img src="img/pic/yoga5.jpeg" alt=""></a>
									</div>
								...
								<div class="dz-box box-1 style-1">
									<div class="dz-media">
                                                                            <a href="portfolio.html"><img src="img/pic/yoga6.jpeg" alt=""></a>
									</div>
								...
								<div class="dz-box box-1 style-1">
									<div class="dz-media">
                                                                            <a href="portfolio.html"><img src="img/pic/yoga7.jpeg" alt=""></a>
									</div>
			...
			<img class="bg-image" src="assets/images/pattern/pattern5.svg" alt="">
		</section>
				</div>
			</div>
			<!-- blog grid END -->
