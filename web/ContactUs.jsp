<%-- 
    Document   : ContactUs
    Created on : 28 Jul, 2023, 1:04:37 PM
    Author     : nandy
--%>
	...
	<div class="page-content bg-white">
							...
							<div class="widget widget_getintuch m-0">
								<ul>
									<li>
										...
										<p>Samarpana YogaShala,CA 94126 India</p>
									</li>
									<li>
										<i class="fa-solid fa-phone"></i>
                                                                                <a href="tel:7259060981" style="color: black">+91 7259060981</a>
									</li>
									<li>
										<i class="fa-solid fa-envelope"></i>
										<a href="mailto:samarpanayogashala@gmail.com" style="color: black">samarpanayogashala@gmail.com</a>
									</li>
					...
					<div class="col-lg-6 col-md-12 col-xl-7">
						<div class="dz-form-card bg-secondary">
							<div class="section-head">
								...
								<p class="text-white m-t10">Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
							</div>
							<form class="dzForm" method="POST" action="assets/script/contact_smtp.php">
								...
								<div class="row">
									...
									<div class="col-xl-6 col-md-6">
										...
										<div class="input-group input-line input-white">
											<input name="dzEmail" required="" type="text" class="form-control" placeholder="info@gmail.com">
										</div>
									</div>
									<div class="col-xl-6 col-md-6">
									...
									<div class="col-lg-6 col-md-6">
										<label class="form-label text-primary">Company Name</label>
										<div class="input-group input-line input-white">
									...
									<div class="col-sm-12">
										<div class="input-recaptcha m-b30 m-lg-b10">
									...
									<div class="col-sm-12">
										<div class="d-sm-flex justify-content-between align-items-center">
											<div class="form-check m-xs-b20">
												<input class="form-check-input checkbox-primary m-r15" type="checkbox" value="" id="flexCheckDefault">
												<label class="form-check-label text-light mb-0" for="flexCheckDefault">Accept terms & conditions</label>
											</div>
											<div class="col-xl-5 col-lg-3 col-sm-4">
												<button name="submit" type="submit" value="Submit" class="btn w-100 btn-white">Submit</button>
											</div>
										</div>	
									</div>
								</div>
		...
		<div class="container content-inner-1">
			<div class="map-iframe style-1">
				<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3886.893538720035!2d77.487713!3d13.042448!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae3cb0b4145dff%3A0x6835090bcc497efe!2sMysore%20Lamp%20Employees%20Cooperative%20Society%20Layout%2C%20Chikkabidarakallu%2C%20Bengaluru%2C%20Karnataka%20560073%2C%20India!5e0!3m2!1sen!2sus!4v1690552702970!5m2!1sen!2sus" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
			</div>
		</div>
	</div>
