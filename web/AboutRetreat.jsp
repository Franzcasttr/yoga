<%-- 
    Document   : AboutRetreat
    Created on : 30 Jul, 2023, 11:26:54 AM
    Author     : nandy
--%>
...
<div class="page-wraper">
	...
	<div class="page-content bg-white">
				...
				<div class="dz-bnr-inr-entry">
					...
					<nav aria-label="breadcrumb" class="breadcrumb-row">
						<ul class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page">About Retreat</li>
						</ul>
					</nav>
					<!-- Breadcrumb Row End -->
				</div>
		...
		<!-- Health Section -->
		<section class="content-inner-1 overflow-hidden pt-lg-4">
			<div class="container">
				<div class="row">
						...
						<div class="col-lg-12">
									...
									<div class="dz-media rounded-sm">
                                                                            <img src="img/yogaretreat/g5.jpg" style="height: 400px" alt="">
									</div>
				...
				<div class="col-lg-12">
						<div class="section-head me-lg-2 text-lg-start text-center">
                                                    <span class="sub-title text-secondary">HOW TO REACH OUR SCHOOL</span><bR>
							<div class="dz-separator style-3">
								<img src="assets/images/lotus.svg" alt="">
							</div>
                                                        <p>BY AIR The nearest airport is Trivandrum International Airport, which is at a distance of 50 kms from Varkala. A student can get down at the airport and take a cab to the location of the school or ask school to arrange for a pickup while booking the course.</p>

 </p>
                                                        <p>BY BUS Varkala is well connected by national state highways from major cities and many governments as well as private buses that run to and fro from the city. </p>
                                                        <p>By TAXI PICK UP School provides taxi pick up at a cost of 25 USD only</p>
						</div>
                                            <div class="section-head me-lg-2 text-lg-start text-center">
                                                <span class="sub-title text-secondary">BENEFITS OF OUR RETREAT</span><br>
							<div class="dz-separator style-3">
								<img src="assets/images/lotus.svg" alt="">
							</div>
                                                        <p>As the finest yoga center in India, our Ayurveda retreats in Kerala provide you with several physical, mental, and spiritual benefits. Below are some of the ways you will improve your quality of life when you attend our Kerala retreat program: Unwind and rejuvenate yourself away from the daily hustle and bustle Immerse yourself in the gorgeous surroundings around you Learn yoga from some of the most illustrious yoga gurus in the country Practice the power of chanting through Mantra Yoga Gain insightful knowledge about Yoga philosophy and how to implement them in daily life Learn the medicinal qualities of herbs and other Ayurvedic plants Attend Ayurvedic Cooking classes and try your hands-on cooking satvik Ayurvedic meals Delve in deeper and soulful conversations with like-minded yogis and world travelers Connect with your deeper self as you go on a blissful journey of yoga, meditation and Ayurveda Get in touch with your spiritual being Learn to harmonize your mind, body, and soul.</p>

						</div>
                                            <div class="section-head me-lg-2 text-lg-start text-center">
                                                <span class="sub-title text-secondary">OUTCOMES OF OUR RETREAT</span><br>
							<div class="dz-separator style-3">
								<img src="assets/images/lotus.svg" alt="">
							</div>
                                                        <p>Whether you are a beginner or a professional yoga instructor, we assure you that after spending your valuable time learning and practicing yoga and Ayurveda with us during your retreat, you will: Feel rejuvenated and stress-free of all your problems Feel more in-sync with your mind, body, soul Be in touch with the healthy side of you Learn how to make delectable Ayurvedic meals Have hearty conversations with like-minded souls from around the globe Go home as a transformed person.</p>
